...
* Python
  #+BEGIN_SRC emacs-lisp
        ...
        ; (setq python-shell-virtualenv-root "/home/carsten/miniconda/envs/dato-env")
        ;(setq python-environment-default-root-name "dato-env")
        ;(setq python-environment-directory "/home/carsten/miniconda/envs")
